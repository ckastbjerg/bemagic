...
module.exports = function({ systemName, namespace, themeClass }) {
    return stripIndents`
        ## ${systemName} naming conventions

        ${systemName} follows [BEM naming conventions](http://getbem.com/naming/).
        ...
        * [Cascades](#cascades)
        ...
        All components in the ${systemName} design system must use this syntax.
        ...
        * It helps to decouple presentation semantics from document semantics.
        ...
        avoid potential collisions when ${systemName} is used in conjunction with other CSS
        ...
        **${systemName} components should never be styled from within other components**
